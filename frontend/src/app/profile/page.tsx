...
import { LogOut, ListOrdered, ChevronRight, User, Heart, Search, Trash2, Ticket, Bell } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pb-20" style={{ background: 'var(--li-page-bg)' }}>
      ...
      <div className="p-4 space-y-3">
        ...
        <MenuCard href="/profile/alerts" icon={<Bell className="w-5 h-5" />} label="Alerts & Preferences" description="Interests and how often we notify you" />
