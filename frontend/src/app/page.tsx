...
const TRUST: TrustDef[] = [
  ...
  },
  {
    ...
    subtitle: 'Contact sellers directly — no middlemen.',
    iconBg: 'bg-emerald-500/[0.15]',
    iconColor: 'text-emerald-400',
  },
  {
    icon: MapPin,
    title: 'Localized Scale',
    subtitle: '140+ cities across South India.',
  ...
  },
  {
    ...
    subtitle: '11 native languages, your way.',
        ...
        <div className="page-wrap relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-[3.75rem] font-extrabold text-white
              ...
              Buy. Sell. Connect.<br />
              <span className="text-orange-500">In Your City.</span>
            </h1>

            {/* Sub-text */}
            <p className="text-base md:text-lg text-slate-400 max-w-lg leading-relaxed mb-10">
              Post listings, find PGs, discover local services —
            ...
            <form
              ...
              className="flex max-w-2xl w-full rounded-2xl bg-white shadow-2xl shadow-black/30
                ...
                focus-within:ring-4 focus-within:ring-orange-500/[0.18] focus-within:shadow-orange-500/[0.08]"
            >
              {/* City trigger */}
              <button
                type="button"
              ...
              >
                ...
                <span className="flex-1 text-sm font-semibold text-slate-800 truncate text-left">
                  {selectedCityName ?? 'Select City'}
                </span>
                <ChevronDown
                  className="w-3.5 h-3.5 text-slate-400 shrink-0 group-hover:text-slate-600 transition-colors"
                  strokeWidth={2}
                />
              </button>
        ...
        {showCityPicker && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              {/* Body */}
              <div className="overflow-y-auto max-h-[58vh] p-6 space-y-6">
                {/* Recent cities */}
