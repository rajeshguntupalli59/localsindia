...
const SOCIALS = [
  ...
  { label: 'Facebook',    Icon: IconFacebook,   href: 'https://www.facebook.com/profile.php?id=61591815777647',   hover: 'hover:text-blue-400  hover:bg-blue-500/[0.12]' },
