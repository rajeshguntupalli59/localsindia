...
- **app_launch**: promotes the LocalsIndia app being live on Google Play (published to production 2026-08-11 — package `com.localsindia.app`, https://play.google.com/store/apps/details?id=com.localsindia.app) as well as the website (localsindia.com, no install needed). It's fine to say "download now" / "available on Google Play" / "get the app". Note: the listing may take 24-48h after publish to show up in Play Store *search* — if that matters for a specific post, favor phrasing that doesn't hinge on search discovery (e.g. "search LocalsIndia on Google Play or visit localsindia.com") over "search for us." Don't claim install counts or ratings — it just launched.
